...
get_rna_matrix <- function(gene_tumor, gene_normal, output)
{
	...
	index <- which(colnames(cnv_rna_res) %in% normal_cells)
	if(length(index)==0)
	{normal_cells <- sub('[.]','-',normal_cells)}
...
output <- './Results/10x/all_cell/copykat/v1/'
...
results <- get_rna_matrix(gene_hcc1395, gene_hcc1395bl, output)
...
output <- './Results/c1_fda/all_cell/copykat/v1/'
dir.create(output,recursive=T)
...
output <- './Results/c1_llu/all_cell/copykat/v1/'
dir.create(output,recursive=T)
...
output <- './Results/WaferGen/all_cell/copykat/v1/'
dir.create(output,recursive=T)
...
output <- './Results/10x/all_cell/copykat/v2/'
dir.create(output,recursive=T)
...
colnames(gene_hcc1395bl) <- paste0(colnames(gene_hcc1395bl),'_2')
results <- get_rna_matrix2(gene_hcc1395, gene_hcc1395bl, output)
...
input <- './Data/RNAseq/merge/Star/NCBI_GRCh38/Gtf/'
output <- './Results/c1_fda/all_cell/copykat/v2/'
dir.create(output,recursive=T)
...
input <- './Data/RNAseq/merge/Star/NCBI_GRCh38/Gtf/'
output <- './Results/c1_llu/all_cell/copykat/v2/'
dir.create(output,recursive=T)
...
input <- './Data/RNAseq/merge/Star/NCBI_GRCh38/Gtf/'
output <- './Results/WaferGen/all_cell/copykat/v2/'
dir.create(output,recursive=T)
...
input <- './Data/RNAseq/merge/Star/NCBI_GRCh38/Gtf/'
output <- './Results/bulk/copykat/v2/'
dir.create(output,recursive=T)
...
input <- './Anno/GTEx/'
output <- './Results/10x/all_cell/copykat/v3/'
dir.create(output,recursive=T)
...
input <- './Anno/GTEx/'
output <- './Results/c1_fda/all_cell/copykat/v3/'
dir.create(output,recursive=T)
...
input <- './Anno/GTEx/'
output <- './Results/c1_llu/all_cell/copykat/v3/'
dir.create(output,recursive=T)
...
input <- './Anno/GTEx/'
output <- './Results/WaferGen/all_cell/copykat/v3/'
dir.create(output,recursive=T)
...
input <- './Anno/GTEx/'
output <- './Results/bulk/all_cell/copykat/v3/'
dir.create(output,recursive=T)
