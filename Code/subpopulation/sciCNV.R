...
input2 <- './Anno/'
output <- './Results/Tian/scicnv/10x_3cl_310/results/'
...
input2 <- './Anno/'
output <- './Results/Tian/scicnv/10x_3cl_220/results/'
dir.create(output,recursive=T)
...
input2 <- './Anno/'
output <- './Results/Tian/scicnv/10x_5cl_310/results/'
dir.create(output,recursive=T)
...
input2 <- './Anno/'
output <- './Results/Tian/scicnv/10x_5cl_201/results/'
dir.create(output,recursive=T)
...
input2 <- './Anno/'
output <- './Results/Tian/scicnv/celseq/results/'
dir.create(output,recursive=T)
...
input2 <- './Anno/'
output <- './Results/Tian/scicnv/dropseq/results/'
dir.create(output,recursive=T)
